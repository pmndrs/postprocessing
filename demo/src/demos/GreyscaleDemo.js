...
/**
 * A greyscale demo setup.
 */

export class GreyscaleDemo extends PostProcessingDemo {

	/**
	 * Constructs a new greyscale demo.
	 *
	...
	constructor(composer) {
		...
		super("greyscale", composer);

		/**
		 * A luminance-based greyscale effect.
		 *
		 * @type {Effect}
		 * @private
		 */
	...
	initialize() {
		...
		const greyscaleEffect = new GreyscaleEffect(BlendFunction.NORMAL);

		const pass = new EffectPass(camera, smaaEffect, greyscaleEffect);
		this.renderPass.renderToScreen = false;
		pass.renderToScreen = true;
		pass.dithering = true;

		this.effect = greyscaleEffect;
		this.pass = pass;
