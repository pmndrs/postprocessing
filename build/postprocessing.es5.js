...
( function( global, factory ) {
	( typeof exports === 'undefined' ? 'undefined' : _typeof( exports ) ) === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ) ) : typeof define === 'function' && define.amd ? define( [ 'exports', 'three' ], factory ) : factory( global.POSTPROCESSING = global.POSTPROCESSING || {}, global.THREE );
	 ...
	 * @constructor
	 */
	var AdaptiveLuminosityMaterial = function( _THREE$ShaderMaterial ) {
		_inherits( AdaptiveLuminosityMaterial, _THREE$ShaderMaterial );

		function AdaptiveLuminosityMaterial() {
			_classCallCheck( this, AdaptiveLuminosityMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( AdaptiveLuminosityMaterial )
				.call( this, {
	 ...
	 */
	var BokehMaterial = function( _THREE$ShaderMaterial2 ) {
		_inherits( BokehMaterial, _THREE$ShaderMaterial2 );

		function BokehMaterial( camera, options ) {
			_classCallCheck( this, BokehMaterial );
			if ( options === undefined ) {
				options = {};
			}
			var _this2 = _possibleConstructorReturn( this, Object.getPrototypeOf( BokehMaterial )
				.call( this, {
					type: "BokehMaterial",
					uniforms: {
						tDiffuse: {
						...
						focus: {
							value: options.focus !== undefined ? options.focus : 1.0
						},
						aspect: {
							value: options.aspect !== undefined ? options.aspect : 1.0
						},
						aperture: {
							value: options.aperture !== undefined ? options.aperture : 0.025
						},
						maxBlur: {
							value: options.maxBlur !== undefined ? options.maxBlur : 1.0
						}
					},
	 ...
	 */
	var Bokeh2Material = function( _THREE$ShaderMaterial3 ) {
		_inherits( Bokeh2Material, _THREE$ShaderMaterial3 );

		function Bokeh2Material( camera, options ) {
			_classCallCheck( this, Bokeh2Material );
			if ( options === undefined ) {
				options = {};
			}
			...
			var _this3 = _possibleConstructorReturn( this, Object.getPrototypeOf( Bokeh2Material )
				.call( this, {
					type: "Bokeh2Material",
					defines: {
			...
			if ( options.showFocus ) {
				_this3.defines.SHOW_FOCUS = "1";
			}
			if ( options.manualDoF ) {
				_this3.defines.MANUAL_DOF = "1";
			}
			if ( options.vignette ) {
				_this3.defines.VIGNETTE = "1";
			}
			if ( options.pentagon ) {
				_this3.defines.PENTAGON = "1";
			}
			if ( options.shaderFocus ) {
				_this3.defines.SHADER_FOCUS = "1";
			}
			if ( options.noise ) {
				_this3.defines.NOISE = "1";
			}
			if ( options.texelSize !== undefined ) {
				_this3.setTexelSize( options.texelSize.x, options.texelSize.y );
			}
			if ( camera !== undefined ) {
		 ...
		 */
		_createClass( Bokeh2Material, [ {
			key: 'setTexelSize',
			value: function setTexelSize( x, y ) {
					this.uniforms.texelSize.value.set( x, y );
					this.uniforms.halfTexelSize.value.set( x, y )
						.multiplyScalar( 0.5 );
				}
				/**
	 ...
	 */
	var CombineMaterial = function( _THREE$ShaderMaterial4 ) {
		_inherits( CombineMaterial, _THREE$ShaderMaterial4 );

		function CombineMaterial( invertTexture1, invertTexture2 ) {
			_classCallCheck( this, CombineMaterial );
			var _this4 = _possibleConstructorReturn( this, Object.getPrototypeOf( CombineMaterial )
				.call( this, {
			...
			if ( invertTexture1 ) {
				_this4.defines.INVERT_TEX1 = "1";
			}
			if ( invertTexture2 ) {
				_this4.defines.INVERT_TEX2 = "1";
			}
			return _this4;
		}
	 ...
	 */
	var ConvolutionMaterial = function( _THREE$ShaderMaterial5 ) {
		_inherits( ConvolutionMaterial, _THREE$ShaderMaterial5 );
		...
		function ConvolutionMaterial( texelSize ) {
			 ...
			 * @private
			 */
			var _this5 = _possibleConstructorReturn( this, Object.getPrototypeOf( ConvolutionMaterial )
				.call( this, {
			...
			_this5.kernels = new Float32Array( [ 0.0, 1.0, 2.0, 2.0, 3.0 ] );
			/**
			 * Scales the kernels.
			 *
			 * @property scale
	 ...
	 * @constructor
	 */
	var CopyMaterial = function( _THREE$ShaderMaterial6 ) {
		_inherits( CopyMaterial, _THREE$ShaderMaterial6 );

		function CopyMaterial() {
			_classCallCheck( this, CopyMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( CopyMaterial )
				.call( this, {
					type: "CopyMaterial",
					uniforms: {
						tDiffuse: {
	 ...
	 */
	var DotScreenMaterial = function( _THREE$ShaderMaterial7 ) {
		_inherits( DotScreenMaterial, _THREE$ShaderMaterial7 );

		function DotScreenMaterial( average ) {
			_classCallCheck( this, DotScreenMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( DotScreenMaterial )
				.call( this, {
					...
					uniforms: {
						...
						offsetRepeat: {
							value: new THREE.Vector4( 0.5, 0.5, 1.0, 1.0 )
						}
					},
	 ...
	 */
	var FilmMaterial = function( _THREE$ShaderMaterial8 ) {
		_inherits( FilmMaterial, _THREE$ShaderMaterial8 );

		function FilmMaterial( options ) {
			_classCallCheck( this, FilmMaterial );
			if ( options === undefined ) {
				options = {};
			} // These are enabled by default.
			var _this8 = _possibleConstructorReturn( this, Object.getPrototypeOf( FilmMaterial )
				.call( this, {
					type: "FilmMaterial",
					uniforms: {
						tDiffuse: {
						...
						noiseIntensity: {
							value: options.noiseIntensity !== undefined ? options.noiseIntensity : 0.5
						},
						scanlineIntensity: {
							value: options.scanlineIntensity !== undefined ? options.scanlineIntensity : 0.05
						},
						scanlineCount: {
							value: 0.0
						},
						greyscaleIntensity: {
							value: options.greyscaleIntensity !== undefined ? options.greyscaleIntensity : 1.0
						},
						sepiaIntensity: {
							value: options.sepiaIntensity !== undefined ? options.sepiaIntensity : 1.0
						},
						vignetteOffset: {
							value: options.vignetteOffset !== undefined ? options.vignetteOffset : 1.0
						},
						vignetteDarkness: {
							value: options.vignetteDarkness !== undefined ? options.vignetteDarkness : 1.0
						}
					},
			...
			if ( options.scanlines === undefined || options.scanlines ) {
				_this8.defines.SCANLINES = "1";
			}
			if ( options.noise === undefined || options.noise ) {
				_this8.defines.NOISE = "1";
			}
			if ( options.greyscale ) {
				_this8.defines.GREYSCALE = "1";
			}
			if ( options.sepia ) {
				_this8.defines.SEPIA = "1";
			}
			if ( options.vignette ) {
				_this8.defines.VIGNETTE = "1";
			}
			if ( options.eskil ) {
				_this8.defines.ESKIL = "1";
			}
			return _this8;
		}
		return FilmMaterial;
	 ...
	 * @constructor
	 */
	var GlitchMaterial = function( _THREE$ShaderMaterial9 ) {
		_inherits( GlitchMaterial, _THREE$ShaderMaterial9 );

		function GlitchMaterial() {
			_classCallCheck( this, GlitchMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( GlitchMaterial )
				.call( this, {
					type: "GlitchMaterial",
					uniforms: {
						tDiffuse: {
	 ...
	 * @constructor
	 */
	var GodRaysMaterial = function( _THREE$ShaderMaterial10 ) {
		_inherits( GodRaysMaterial, _THREE$ShaderMaterial10 );

		function GodRaysMaterial() {
			_classCallCheck( this, GodRaysMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( GodRaysMaterial )
				.call( this, {
	 ...
	 */
	var LuminosityMaterial = function( _THREE$ShaderMaterial11 ) {
		_inherits( LuminosityMaterial, _THREE$ShaderMaterial11 );

		function LuminosityMaterial( color, range ) {
			_classCallCheck( this, LuminosityMaterial );
			var _this11 = _possibleConstructorReturn( this, Object.getPrototypeOf( LuminosityMaterial )
				.call( this, {
					...
					uniforms: {
						...
						range: {
							value: range !== undefined ? range : new THREE.Vector2()
						}
					},
			...
			if ( color !== undefined ) {
				_this11.defines.COLOR = "1";
			}
			if ( range !== undefined ) {
				_this11.defines.RANGE = "1";
			}
			return _this11;
		}
	 ...
	 * @param {Vector2} [texelSize] - The absolute screen texel size.
	 */
	var SMAABlendMaterial = function( _THREE$ShaderMaterial12 ) {
		_inherits( SMAABlendMaterial, _THREE$ShaderMaterial12 );

		function SMAABlendMaterial( texelSize ) {
			_classCallCheck( this, SMAABlendMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( SMAABlendMaterial )
				.call( this, {
					...
					uniforms: {
						...
						texelSize: {
							value: texelSize !== undefined ? texelSize : new THREE.Vector2()
						}
					},
	 ...
	 * @param {Vector2} [texelSize] - The absolute screen texel size.
	 */
	var SMAAColorEdgesMaterial = function( _THREE$ShaderMaterial13 ) {
		_inherits( SMAAColorEdgesMaterial, _THREE$ShaderMaterial13 );

		function SMAAColorEdgesMaterial( texelSize ) {
			_classCallCheck( this, SMAAColorEdgesMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( SMAAColorEdgesMaterial )
				.call( this, {
	 ...
	 * @param {Vector2} [texelSize] - The absolute screen texel size.
	 */
	var SMAAWeightsMaterial = function( _THREE$ShaderMaterial14 ) {
		_inherits( SMAAWeightsMaterial, _THREE$ShaderMaterial14 );

		function SMAAWeightsMaterial( texelSize ) {
			 ...
			 * @type String
			 */
			var _this14 = _possibleConstructorReturn( this, Object.getPrototypeOf( SMAAWeightsMaterial )
				.call( this, {
			 ...
			 * @type String
			 */
			_this14.searchImage = searchImage;
			return _this14;
		}
	 ...
	 * @constructor
	 */
	var ToneMappingMaterial = function( _THREE$ShaderMaterial15 ) {
		_inherits( ToneMappingMaterial, _THREE$ShaderMaterial15 );

		function ToneMappingMaterial() {
			_classCallCheck( this, ToneMappingMaterial );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( ToneMappingMaterial )
				.call( this, {
	...
	var Pass = function() {
		function Pass( scene, camera, quad ) {
			 ...
			 * @default false
			 */
			this.renderToScreen = false; // Finally, add the camera and the quad to the scene.
			if ( this.scene !== null ) {
	...
	var BloomPass = function( _Pass ) {
		...
		function BloomPass( options ) {
			...
			var _this16 = _possibleConstructorReturn( this, Object.getPrototypeOf( BloomPass )
				.call( this ) );
			if ( options === undefined ) {
				options = {};
			}
			 ...
			 * @private
			 */
			_this16.renderTargetX = new THREE.WebGLRenderTarget( 1, 1, {
			 ...
			 * @private
			 */
			_this16.renderTargetY = _this16.renderTargetX.clone();
			/**
			 ...
			 * @default 0.5
			 */
			_this16.resolutionScale = options.resolutionScale === undefined ? 0.5 : options.resolutionScale;
			/**
			 ...
			 * @private
			 */
			_this16.combineMaterial = new CombineMaterial();
			if ( options.strength !== undefined ) {
				_this16.combineMaterial.uniforms.opacity2.value = options.strength;
			}
			/**
			 ...
			 * @private
			 */
			_this16.copyMaterial = new CopyMaterial();
			_this16.copyMaterial.blending = THREE.AdditiveBlending;
			_this16.copyMaterial.transparent = true;
			if ( options.strength !== undefined ) {
				_this16.copyMaterial.uniforms.opacity.value = options.strength;
			}
			/**
			 ...
			 * @private
			 */
			_this16.luminosityMaterial = new LuminosityMaterial( true );
			if ( options.distinction !== undefined ) {
				_this16.luminosityMaterial.uniforms.distinction.value = options.distinction;
			}
			/**
			...
			_this16.blurriness = options.blurriness;
			return _this16;
		}
		/**
		...
		_createClass( BloomPass, [ {
			...
			value: function render( renderer, readBuffer ) {
					var state = renderer.state; // Luminance filter.
					...
					state.setDepthWrite( false ); // Convolution phase.
					...
					this.convolutionMaterial.adjustKernel();
					this.convolutionMaterial.uniforms.tDiffuse.value = this.renderTargetX.texture;
					renderer.render( this.scene, this.camera, this.renderTargetY ); // Render the original scene with superimposed blur.
			...
			key: 'blurriness',
			get: function get() {
				return this.convolutionMaterial.scale;
			},
			set: function set( x ) {
				if ( typeof x === "number" ) {
	 ...
	 * @param {Number} [options.maxBlur=1.0] - Maximum blur strength.
	 */
	var BokehPass = function( _Pass2 ) {
		_inherits( BokehPass, _Pass2 );

		function BokehPass( camera, options ) {
			_classCallCheck( this, BokehPass );
			var _this17 = _possibleConstructorReturn( this, Object.getPrototypeOf( BokehPass )
				.call( this ) );
			_this17.needsSwap = true;
			if ( options === undefined ) {
				options = {};
			}
			/**
			 ...
			 * @private
			 */
			_this17.bokehMaterial = new BokehMaterial( camera, options );
			_this17.quad.material = _this17.bokehMaterial;
			return _this17;
		}
		/**
		 * Renders the effect.
	 ...
	 * @param {Boolean} [options.noise=true] - Disable if you don't want noise patterns for dithering.
	 */
	var Bokeh2Pass = function( _Pass3 ) {
		_inherits( Bokeh2Pass, _Pass3 );

		function Bokeh2Pass( camera, options ) {
			_classCallCheck( this, Bokeh2Pass );
			var _this18 = _possibleConstructorReturn( this, Object.getPrototypeOf( Bokeh2Pass )
				.call( this ) );
			if ( options === undefined ) {
				options = {};
			}
			 ...
			 * @private
			 */
			_this18.bokehMaterial = new Bokeh2Material( camera, options );
			_this18.quad.material = _this18.bokehMaterial;
			return _this18;
		}
		/**
		 * Renders the effect.
	 ...
	 * @constructor
	 */
	var ClearMaskPass = function( _Pass4 ) {
		_inherits( ClearMaskPass, _Pass4 );

		function ClearMaskPass() {
			_classCallCheck( this, ClearMaskPass );
			return _possibleConstructorReturn( this, Object.getPrototypeOf( ClearMaskPass )
				.call( this, null, null, null ) );
		}
		/**
	 ...
	 */
	var DotScreenPass = function( _Pass5 ) {
		_inherits( DotScreenPass, _Pass5 );

		function DotScreenPass( options ) {
			_classCallCheck( this, DotScreenPass );
			var _this20 = _possibleConstructorReturn( this, Object.getPrototypeOf( DotScreenPass )
				.call( this ) );
			_this20.needsSwap = true;
			if ( options === undefined ) {
				options = {};
			}
			/**
			 ...
			 * @private
			 */
			_this20.material = new DotScreenMaterial( options.average );
			if ( options.angle !== undefined ) {
				_this20.material.uniforms.angle.value = options.angle;
			}
			if ( options.scale !== undefined ) {
				_this20.material.uniforms.scale.value = options.scale;
			}
			if ( options.intensity !== undefined ) {
				_this20.material.uniforms.intensity.value = options.intensity;
			}
			_this20.quad.material = _this20.material;
			return _this20;
		}
		/**
		 * Renders the effect.
	 ...
	 * @param {Number} [options.vignetteDarkness=1.0] - The darkness of the vignette effect.
	 */
	var FilmPass = function( _Pass6 ) {
		_inherits( FilmPass, _Pass6 );

		function FilmPass( options ) {
			_classCallCheck( this, FilmPass );
			var _this21 = _possibleConstructorReturn( this, Object.getPrototypeOf( FilmPass )
				.call( this ) );
			_this21.needsSwap = true;
			if ( options === undefined ) {
				options = {};
			}
			/**
			 ...
			 * @private
			 */
			_this21.material = new FilmMaterial( options );
			_this21.quad.material = _this21.material;
			/**
			 ...
			 * @default 1.25
			 */
			_this21.scanlineDensity = options.scanlineDensity === undefined ? 1.25 : options.scanlineDensity;
			return _this21;
		}
		/**
		 * Renders the effect.
	 ...
	 */
	var GlitchPass = function( _Pass7 ) {
		_inherits( GlitchPass, _Pass7 );

		function GlitchPass( options ) {
			_classCallCheck( this, GlitchPass );
			var _this22 = _possibleConstructorReturn( this, Object.getPrototypeOf( GlitchPass )
				.call( this ) );
			_this22.needsSwap = true;
			if ( options === undefined ) {
				options = {};
			}
			 ...
			 * @private
			 */
			_this22.material = new GlitchMaterial();
			_this22.quad.material = _this22.material;
			/**
			 * A perturbation map.
			 *
			...
			if ( options.perturbMap !== undefined ) {
				_this22.perturbMap = options.perturbMap;
				_this22.perturbMap.generateMipmaps = false;
				_this22.material.uniforms.tPerturb.value = _this22.perturbMap;
			} else {
				_this22.perturbMap = null;
				_this22.generatePerturbMap( options.dtSize );
			}
			/**
			 * The effect mode.
			 *
			 ...
			 */
			_this22.mode = GlitchPass.Mode.SPORADIC;
			/**
			 ...
			 * @private
			 */
			_this22.breakPoint = 0;
			_this22.generateTrigger();
			return _this22;
		}
		/**
		 * Renders the effect.
	 ...
	 */
	var GodRaysPass = function( _Pass8 ) {
		_inherits( GodRaysPass, _Pass8 );

		function GodRaysPass( scene, camera, lightSource, options ) {
			_classCallCheck( this, GodRaysPass );
			var _this23 = _possibleConstructorReturn( this, Object.getPrototypeOf( GodRaysPass )
				.call( this ) );
			if ( options === undefined ) {
				options = {};
			}
			 ...
			 * @private
			 */
			_this23.renderTargetMask = new THREE.WebGLRenderTarget( 1, 1, {
				minFilter: THREE.LinearFilter,
				magFilter: THREE.LinearFilter,
				generateMipmaps: false
			} );
			 ...
			 * @private
			 */
			_this23.renderTargetX = _this23.renderTargetMask.clone();
			_this23.renderTargetX.stencilBuffer = false;
			_this23.renderTargetX.depthBuffer = false;
			/**
			 * A second render target.
			 *
			 * @property renderTargetY
			 ...
			 * @private
			 */
			_this23.renderTargetY = _this23.renderTargetX.clone();
			/**
			 * The resolution scale.
			 *
			 ...
			 * @default 0.5
			 */
			_this23.resolutionScale = options.resolutionScale === undefined ? 0.5 : options.resolutionScale;
			/**
			 * The light source.
			 *
			 ...
			 * @type Object3D
			 */
			_this23.lightSource = lightSource !== undefined ? lightSource : new THREE.Object3D();
			/**
			 ...
			 * @private
			 */
			_this23.screenPosition = new THREE.Vector3();
			/**
			 * A convolution blur shader material.
			 *
			 * @property convolutionMaterial
			 ...
			 * @private
			 */
			_this23.convolutionMaterial = new ConvolutionMaterial();
			_this23.blurriness = options.blurriness !== undefined ? options.blurriness : 0.1;
			/**
			 ...
			 * @private
			 */
			_this23.combineMaterial = new CombineMaterial();
			/**
			 ...
			 * @private
			 */
			_this23.copyMaterial = new CopyMaterial();
			_this23.copyMaterial.blending = THREE.AdditiveBlending;
			_this23.copyMaterial.transparent = true;
			/**
			 ...
			 * @private
			 */
			_this23.maskMaterial = new THREE.MeshBasicMaterial( {
				color: 0x000000
			} );
			/**
			 ...
			 * @private
			 */
			_this23.godRaysMaterial = new GodRaysMaterial();
			_this23.godRaysMaterial.uniforms.lightPosition.value = _this23.screenPosition;
			if ( options.exposure !== undefined ) {
				_this23.godRaysMaterial.uniforms.exposure.value = options.exposure;
			}
			if ( options.density !== undefined ) {
				_this23.godRaysMaterial.uniforms.density.value = options.density;
			}
			if ( options.decay !== undefined ) {
				_this23.godRaysMaterial.uniforms.decay.value = options.decay;
			}
			if ( options.weight !== undefined ) {
				_this23.godRaysMaterial.uniforms.weight.value = options.weight;
			}
			if ( options.clampMax !== undefined ) {
				_this23.godRaysMaterial.uniforms.clampMax.value = options.clampMax;
			}
			_this23.samples = options.samples;
			_this23.intensity = options.intensity;
			/**
			 * The main scene.
			 *
			 * @property mainScene
			 * @type Scene
			 */
			_this23.mainScene = scene !== undefined ? scene : new THREE.Scene();
			/**
			 * The main camera.
			 *
			 * @property mainCamera
			 * @type Camera
			 */
			_this23.mainCamera = camera !== undefined ? camera : new THREE.PerspectiveCamera();
			return _this23;
		}
		/**
		 * The strength of the preliminary blur phase.
		...
		_createClass( GodRaysPass, [ {
			...
			value: function render( renderer, readBuffer ) {
					...
					var state = renderer.state; // Compute the screen light position and translate the coordinates to [0, 1].
					this.screenPosition.copy( this.lightSource.position )
						.project( this.mainCamera );
					this.screenPosition.x = THREE.Math.clamp( ( this.screenPosition.x + 1.0 ) * 0.5, 0.0, 1.0 );
					this.screenPosition.y = THREE.Math.clamp( ( this.screenPosition.y + 1.0 ) * 0.5, 0.0, 1.0 ); // Render the masked scene.
					...
					this.mainScene.overrideMaterial = null; // Convolution phase (5 passes).
					this.quad.material = this.convolutionMaterial;
					this.convolutionMaterial.adjustKernel();
					...
					this.convolutionMaterial.adjustKernel();
					this.convolutionMaterial.uniforms.tDiffuse.value = this.renderTargetY.texture;
					renderer.render( this.scene, this.camera, this.renderTargetX ); // God rays pass.
					this.quad.material = this.godRaysMaterial;
					this.godRaysMaterial.uniforms.tDiffuse.value = this.renderTargetX.texture;
					renderer.render( this.scene, this.camera, this.renderTargetY ); // Final pass - composite god rays onto colors.
					if ( this.renderToScreen ) {
						this.quad.material = this.combineMaterial;
						this.combineMaterial.uniforms.texture1.value = readBuffer.texture;
						this.combineMaterial.uniforms.texture2.value = this.renderTargetY.texture;
	 ...
	 */
	var MaskPass = function( _Pass9 ) {
		_inherits( MaskPass, _Pass9 );
		...
		function MaskPass( scene, camera ) {
			 ...
			 * @default false
			 */
			var _this24 = _possibleConstructorReturn( this, Object.getPrototypeOf( MaskPass )
				.call( this, scene, camera, null ) );
		...
		_createClass( MaskPass, [ {
			...
			value: function render( renderer, readBuffer, writeBuffer ) {
				...
				state.clearStencil( clearValue ); // Draw the mask into both buffers.
				renderer.render( this.scene, this.camera, readBuffer, this.clear );
				renderer.render( this.scene, this.camera, writeBuffer, this.clear ); // Re-enable update of color and depth.
				state.setColorWrite( true );
				state.setDepthWrite( true ); // Only render where stencil is set to 1.
	 ...
	 */
	var RenderPass = function( _Pass10 ) {
		_inherits( RenderPass, _Pass10 );

		function RenderPass( scene, camera, options ) {
			_classCallCheck( this, RenderPass );
			var _this25 = _possibleConstructorReturn( this, Object.getPrototypeOf( RenderPass )
				.call( this, scene, camera, null ) );
			if ( options === undefined ) {
				options = {};
			}
			 ...
			 * @type Material
			 */
			_this25.overrideMaterial = options.overrideMaterial !== undefined ? options.overrideMaterial : null;
			/**
			 * Clear color.
			 *
			 * @property clearColor
			 * @type Color
			 */
			_this25.clearColor = options.clearColor !== undefined ? options.clearColor : null;
			/**
			 * Clear alpha.
			 *
			 * @property clearAlpha
			 * @type Number
			 */
			_this25.clearAlpha = options.clearAlpha === undefined ? 1.0 : THREE.Math.clamp( options.clearAlpha, 0.0, 1.0 );
			/**
			 * Clear flag.
			 *
			 * @property clear
	 ...
	 */
	var SavePass = function( _Pass11 ) {
		_inherits( SavePass, _Pass11 );
		...
		function SavePass( renderTarget, resize ) {
			 ...
			 * @private
			 */
			var _this26 = _possibleConstructorReturn( this, Object.getPrototypeOf( SavePass )
				.call( this ) );
			_this26.material = new CopyMaterial();
			_this26.quad.material = _this26.material;
			/**
			 * The render target.
			 *
			 ...
			 * @private
			 */
			_this26.renderTarget = renderTarget !== undefined ? renderTarget : null;
			/**
			 ...
			 * @default true
			 */
			_this26.resize = resize !== undefined ? resize : true;
			return _this26;
		}
		/**
	 ...
	 */
	var SMAAPass = function( _Pass12 ) {
		_inherits( SMAAPass, _Pass12 );

		function SMAAPass( Image ) {
			_classCallCheck( this, SMAAPass );
			var _this27 = _possibleConstructorReturn( this, Object.getPrototypeOf( SMAAPass )
				.call( this ) );
			_this27.needsSwap = true;
			/**
			 ...
			 * @private
			 */
			_this27.renderTargetColorEdges = new THREE.WebGLRenderTarget( 1, 1, {
				minFilter: THREE.LinearFilter,
			 ...
			 * @private
			 */
			_this27.renderTargetWeights = _this27.renderTargetColorEdges.clone();
			_this27.renderTargetWeights.texture.format = THREE.RGBAFormat;
			/**
			 ...
			 * @private
			 */
			_this27.colorEdgesMaterial = new SMAAColorEdgesMaterial();
			/**
			 ...
			 * @private
			 */
			_this27.weightsMaterial = new SMAAWeightsMaterial();
			var areaImage = new Image();
			areaImage.src = _this27.weightsMaterial.areaImage;
			...
			searchImage.src = _this27.weightsMaterial.searchImage;
			...
			_this27.weightsMaterial.uniforms.tDiffuse.value = _this27.renderTargetColorEdges.texture;
			_this27.weightsMaterial.uniforms.tArea.value = areaTexture;
			_this27.weightsMaterial.uniforms.tSearch.value = searchTexture;
			/**
			 ...
			 * @private
			 */
			_this27.blendMaterial = new SMAABlendMaterial();
			_this27.blendMaterial.uniforms.tWeights.value = _this27.renderTargetWeights.texture;
			_this27.quad.material = _this27.blendMaterial;
			return _this27;
		}
		/**
		...
		_createClass( SMAAPass, [ {
			key: 'render',
			value: function render( renderer, readBuffer, writeBuffer ) { // Detect color edges.
					this.quad.material = this.colorEdgesMaterial;
					this.colorEdgesMaterial.uniforms.tDiffuse.value = readBuffer.texture;
					renderer.render( this.scene, this.camera, this.renderTargetColorEdges, true ); // Compute edge weights.
					this.quad.material = this.weightsMaterial;
					renderer.render( this.scene, this.camera, this.renderTargetWeights, false ); // Apply the antialiasing filter to the colors.
	 ...
	 */
	var ShaderPass = function( _Pass13 ) {
		_inherits( ShaderPass, _Pass13 );

		function ShaderPass( material, textureID ) {
			_classCallCheck( this, ShaderPass );
			var _this28 = _possibleConstructorReturn( this, Object.getPrototypeOf( ShaderPass )
				.call( this ) );
			_this28.needsSwap = true;
			/**
			 ...
			 * @default "tDiffuse"
			 */
			_this28.textureID = textureID !== undefined ? textureID : "tDiffuse";
			/**
			 ...
			 * @type ShaderMaterial
			 */
			_this28.material = material !== undefined ? material : null;
			_this28.quad.material = _this28.material;
			return _this28;
		}
		/**
		 * Renders the effect.
	 ...
	 */
	var ToneMappingPass = function( _Pass14 ) {
		_inherits( ToneMappingPass, _Pass14 );

		function ToneMappingPass( options ) {
			_classCallCheck( this, ToneMappingPass );
			var _this29 = _possibleConstructorReturn( this, Object.getPrototypeOf( ToneMappingPass )
				.call( this ) );
			_this29.needsSwap = true;
			if ( options === undefined ) {
				options = {};
			}
			/**
			 ...
			 * @private
			 */
			_this29.renderTargetLuminosity = new THREE.WebGLRenderTarget( 1, 1, {
			 ...
			 * @private
			 */
			_this29.renderTargetAdapted = _this29.renderTargetLuminosity.clone();
			_this29.renderTargetAdapted.texture.generateMipmaps = false;
			_this29.renderTargetAdapted.texture.minFilter = THREE.LinearFilter;
			/**
			 ...
			 * @private
			 */
			_this29.renderTargetPrevious = _this29.renderTargetAdapted.clone();
			/**
			 ...
			 * @private
			 */
			_this29.copyMaterial = new CopyMaterial();
			/**
			 ...
			 * @private
			 */
			_this29.luminosityMaterial = new LuminosityMaterial();
			_this29.luminosityMaterial.uniforms.distinction.value = options.distinction === undefined ? 1.0 : options.distinction;
			/**
			 ...
			 * @private
			 */
			_this29.adaptiveLuminosityMaterial = new AdaptiveLuminosityMaterial();
			_this29.resolution = options.resolution === undefined ? 256 : options.resolution;
			/**
			 ...
			 * @private
			 */
			_this29.toneMappingMaterial = new ToneMappingMaterial();
			_this29.adaptive = options.adaptive === undefined ? true : options.adaptive;
			return _this29;
		}
		/**
		...
		_createClass( ToneMappingPass, [ {
			...
			value: function render( renderer, readBuffer, writeBuffer, delta ) {
					var state = renderer.state;
					if ( this.adaptive ) { // Render the luminance of the current scene into a render target with mipmapping enabled.
						this.quad.material = this.luminosityMaterial;
						this.luminosityMaterial.uniforms.tDiffuse.value = readBuffer.texture;
						state.setDepthWrite( true );
						renderer.render( this.scene, this.camera, this.renderTargetLuminosity );
						state.setDepthWrite( false ); // Use the new luminance values, the previous luminance and the frame delta to adapt the luminance over time.
						...
						renderer.render( this.scene, this.camera, this.renderTargetAdapted ); // Copy the new adapted luminance value so that it can be used by the next frame.
						this.quad.material = this.copyMaterial;
			...
			set: function set( x ) {
					if ( typeof x === "number" && x > 0 ) {
						...
						this.adaptiveLuminosityMaterial.defines.MIP_LEVEL_1X1 = ( Math.round( Math.log( x ) ) / Math.log( 2 ) )
							.toFixed( 1 );
	...
	var EffectComposer = function() {
		...
		_createClass( EffectComposer, [ {
			...
			value: function createBuffer( stencilBuffer ) {
					...
					var alpha = this.renderer.context.getContextAttributes()
						.alpha;
			...
			value: function dispose( renderTarget ) {
				...
				if ( renderTarget !== undefined ) { // Reanimate.
