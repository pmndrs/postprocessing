...
(function (global, factory) {
  ...
  var BloomEffect = function (_Effect) {
    ...
    function BloomEffect() {
      ...
      _this16 = _possibleConstructorReturn(this, _getPrototypeOf(BloomEffect).call(this, "BloomEffect", fragment, {
  ...
  var BokehEffect = function (_Effect2) {
    ...
    function BokehEffect() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(BokehEffect).call(this, "BokehEffect", fragment$1, {
        blendFunction: blendFunction,
  ...
  var BrightnessContrastEffect = function (_Effect3) {
    ...
    function BrightnessContrastEffect() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(BrightnessContrastEffect).call(this, "BrightnessContrastEffect", fragment$2, {
        blendFunction: blendFunction,
  ...
  var fragment$3 = "void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float sum=inputColor.r+inputColor.g+inputColor.b;outputColor=vec4(vec3(sum/3.0),inputColor.a);}";
  ...
  var ColorAverageEffect = function (_Effect4) {
    ...
    function ColorAverageEffect() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(ColorAverageEffect).call(this, "ColorAverageEffect", fragment$3, {
        blendFunction: blendFunction
      }));
    }
  ...
  var fragment$4 = "uniform float factor;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(floor(inputColor.rgb*factor+0.5)/factor,inputColor.a);}";
  ...
  var ColorDepthEffect = function (_Effect5) {
    ...
    function ColorDepthEffect() {
      ...
      _this17 = _possibleConstructorReturn(this, _getPrototypeOf(ColorDepthEffect).call(this, "ColorDepthEffect", fragment$4, {
        blendFunction: blendFunction,
  ...
  var ChromaticAberrationEffect = function (_Effect6) {
    ...
    function ChromaticAberrationEffect() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(ChromaticAberrationEffect).call(this, "ChromaticAberrationEffect", fragment$5, {
        blendFunction: blendFunction,
  ...
  var fragment$6 = "void mainImage(const in vec4 inputColor,const in vec2 uv,const in float depth,out vec4 outputColor){\n#ifdef INVERTED\nvec3 color=vec3(1.0-depth);\n#else\nvec3 color=vec3(depth);\n#endif\noutputColor=vec4(color,inputColor.a);}";
  ...
  var DepthEffect = function (_Effect7) {
    ...
    function DepthEffect() {
      ...
      _this18 = _possibleConstructorReturn(this, _getPrototypeOf(DepthEffect).call(this, "DepthEffect", fragment$6, {
        blendFunction: blendFunction,
  ...
  var fragment$7 = "uniform vec2 angle;uniform float scale;float pattern(const in vec2 uv){vec2 point=scale*vec2(dot(angle.yx,vec2(uv.x,-uv.y)),dot(angle,uv));return(sin(point.x)*sin(point.y))*4.0;}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=vec3(inputColor.rgb*10.0-5.0+pattern(uv*resolution));outputColor=vec4(color,inputColor.a);}";
  ...
  var DotScreenEffect = function (_Effect8) {
    ...
    function DotScreenEffect() {
      ...
      _this19 = _possibleConstructorReturn(this, _getPrototypeOf(DotScreenEffect).call(this, "DotScreenEffect", fragment$7, {
        blendFunction: blendFunction,
  ...
  var fragment$8 = "uniform float gamma;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=LinearToGamma(max(inputColor,0.0),gamma);}";
  ...
  var GammaCorrectionEffect = function (_Effect9) {
    ...
    function GammaCorrectionEffect() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(GammaCorrectionEffect).call(this, "GammaCorrectionEffect", fragment$8, {
        blendFunction: blendFunction,
  ...
  var GlitchEffect = function (_Effect10) {
    ...
    function GlitchEffect() {
      ...
      _this20 = _possibleConstructorReturn(this, _getPrototypeOf(GlitchEffect).call(this, "GlitchEffect", fragment$9, {
        blendFunction: blendFunction,
  ...
  var GodRaysEffect = function (_Effect11) {
    ...
    function GodRaysEffect(camera, lightSource) {
      ...
      _this21 = _possibleConstructorReturn(this, _getPrototypeOf(GodRaysEffect).call(this, "GodRaysEffect", fragment, {
        blendFunction: blendFunction,
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([["texture", new three.Uniform(null)]])
      }));
  ...
  var fragment$a = "uniform vec2 scale;uniform float lineWidth;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float grid=0.5-max(abs(mod(uv.x*scale.x,1.0)-0.5),abs(mod(uv.y*scale.y,1.0)-0.5));outputColor=vec4(vec3(smoothstep(0.0,lineWidth,grid)),inputColor.a);}";
  ...
  var GridEffect = function (_Effect12) {
    ...
    function GridEffect() {
      ...
      _this22 = _possibleConstructorReturn(this, _getPrototypeOf(GridEffect).call(this, "GridEffect", fragment$a, {
        blendFunction: blendFunction,
  ...
  var HueSaturationEffect = function (_Effect13) {
    ...
    function HueSaturationEffect() {
      ...
      _this23 = _possibleConstructorReturn(this, _getPrototypeOf(HueSaturationEffect).call(this, "HueSaturationEffect", fragment$b, {
        blendFunction: blendFunction,
  ...
  var fragment$c = "void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 noise=vec3(rand(uv*time));\n#ifdef PREMULTIPLY\noutputColor=vec4(inputColor.rgb*noise,inputColor.a);\n#else\noutputColor=vec4(noise,inputColor.a);\n#endif\n}";
  ...
  var NoiseEffect = function (_Effect14) {
    ...
    function NoiseEffect() {
      ...
      _this24 = _possibleConstructorReturn(this, _getPrototypeOf(NoiseEffect).call(this, "NoiseEffect", fragment$c, {
        blendFunction: blendFunction
      }));
  ...
  var OutlineEffect = function (_Effect15) {
    ...
    function OutlineEffect(scene, camera) {
      ...
      _this25 = _possibleConstructorReturn(this, _getPrototypeOf(OutlineEffect).call(this, "OutlineEffect", fragment$d, {
  ...
  var fragment$e = "uniform bool active;uniform vec2 d;void mainUv(inout vec2 uv){if(active){uv=vec2(d.x*(floor(uv.x/d.x)+0.5),d.y*(floor(uv.y/d.y)+0.5));}}";
  ...
  var PixelationEffect = function (_Effect16) {
    ...
    function PixelationEffect() {
      ...
      _this26 = _possibleConstructorReturn(this, _getPrototypeOf(PixelationEffect).call(this, "PixelationEffect", fragment$e, {
  ...
  var RealisticBokehEffect = function (_Effect17) {
    ...
    function RealisticBokehEffect() {
      ...
      _this27 = _possibleConstructorReturn(this, _getPrototypeOf(RealisticBokehEffect).call(this, "RealisticBokehEffect", fragment$f, {
        blendFunction: blendFunction,
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
  ...
  var fragment$g = "uniform float count;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec2 sl=vec2(sin(uv.y*count),cos(uv.y*count));vec3 scanlines=vec3(sl.x,sl.y,sl.x);outputColor=vec4(scanlines,inputColor.a);}";
  ...
  var ScanlineEffect = function (_Effect18) {
    ...
    function ScanlineEffect() {
      ...
      _this28 = _possibleConstructorReturn(this, _getPrototypeOf(ScanlineEffect).call(this, "ScanlineEffect", fragment$g, {
        blendFunction: blendFunction,
  ...
  var fragment$h = "uniform bool active;uniform vec2 center;uniform float waveSize;uniform float radius;uniform float maxRadius;uniform float amplitude;varying float vSize;void mainUv(inout vec2 uv){if(active){vec2 aspectCorrection=vec2(aspect,1.0);vec2 difference=uv*aspectCorrection-center*aspectCorrection;float distance=sqrt(dot(difference,difference))*vSize;if(distance>radius){if(distance<radius+waveSize){float angle=(distance-radius)*PI2/waveSize;float cosSin=(1.0-cos(angle))*0.5;float extent=maxRadius+waveSize;float decay=max(extent-distance*distance,0.0)/extent;uv-=((cosSin*amplitude*difference)/distance)*decay;}}}}";
  var vertex$2 = "uniform float size;uniform float cameraDistance;varying float vSize;void mainSupport(){vSize=(0.1*cameraDistance)/size;}";
  ...
  var ShockWaveEffect = function (_Effect19) {
    ...
    function ShockWaveEffect(camera) {
      ...
      _this29 = _possibleConstructorReturn(this, _getPrototypeOf(ShockWaveEffect).call(this, "ShockWaveEffect", fragment$h, {
  ...
  var SepiaEffect = function (_Effect20) {
    ...
    function SepiaEffect() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(SepiaEffect).call(this, "SepiaEffect", fragment$i, {
        blendFunction: blendFunction,
  ...
  var SMAAEffect = function (_Effect21) {
    ...
    function SMAAEffect(searchImage, areaImage) {
      ...
      _this30 = _possibleConstructorReturn(this, _getPrototypeOf(SMAAEffect).call(this, "SMAAEffect", fragment$j, {
  ...
  var SSAOEffect = function (_Effect22) {
    ...
    function SSAOEffect(camera, normalBuffer) {
      ...
      _this31 = _possibleConstructorReturn(this, _getPrototypeOf(SSAOEffect).call(this, "SSAOEffect", fragment$k, {
        blendFunction: blendFunction,
        attributes: EffectAttribute.DEPTH,
  ...
  var TextureEffect = function (_Effect23) {
    ...
    function TextureEffect() {
      ...
      _this32 = _possibleConstructorReturn(this, _getPrototypeOf(TextureEffect).call(this, "TextureEffect", fragment, {
        blendFunction: blendFunction,
  ...
  var ToneMappingEffect = function (_Effect24) {
    ...
    function ToneMappingEffect() {
      ...
      _this33 = _possibleConstructorReturn(this, _getPrototypeOf(ToneMappingEffect).call(this, "ToneMappingEffect", fragment$l, {
        blendFunction: blendFunction,
  ...
  var fragment$m = "uniform float offset;uniform float darkness;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){const vec2 center=vec2(0.5);vec3 color=inputColor.rgb;\n#ifdef ESKIL\nvec2 coord=(uv-center)*vec2(offset);color=mix(color,vec3(1.0-darkness),dot(coord,coord));\n#else\nfloat d=distance(uv,center);color*=smoothstep(0.8,offset*0.799,d*(darkness+offset));\n#endif\noutputColor=vec4(color,inputColor.a);}";
  ...
  var VignetteEffect = function (_Effect25) {
    ...
    function VignetteEffect() {
      ...
      _this34 = _possibleConstructorReturn(this, _getPrototypeOf(VignetteEffect).call(this, "VignetteEffect", fragment$m, {
