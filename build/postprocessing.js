/**
 * postprocessing v1.1.3 build Jul 20 2016
...
(function (global, factory) {
	...
	var AdaptiveLuminosityMaterial = (function (superclass) {
		...
		if ( superclass ) AdaptiveLuminosityMaterial.__proto__ = superclass;
		AdaptiveLuminosityMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var BokehMaterial = (function (superclass) {
		...
		if ( superclass ) BokehMaterial.__proto__ = superclass;
		BokehMaterial.prototype = Object.create( superclass && superclass.prototype );
		...
		BokehMaterial.prototype.adoptCameraSettings = function adoptCameraSettings (camera) {
	...
	var Bokeh2Material = (function (superclass) {
		...
		if ( superclass ) Bokeh2Material.__proto__ = superclass;
		Bokeh2Material.prototype = Object.create( superclass && superclass.prototype );
		Bokeh2Material.prototype.constructor = Bokeh2Material;
		...
		Bokeh2Material.prototype.setTexelSize = function setTexelSize (x, y) {
		...
		Bokeh2Material.prototype.adoptCameraSettings = function adoptCameraSettings (camera) {
	...
	var CombineMaterial = (function (superclass) {
		...
		if ( superclass ) CombineMaterial.__proto__ = superclass;
		CombineMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var ConvolutionMaterial = (function (superclass) {
		...
		if ( superclass ) ConvolutionMaterial.__proto__ = superclass;
		ConvolutionMaterial.prototype = Object.create( superclass && superclass.prototype );
		...
		ConvolutionMaterial.prototype.adjustKernel = function adjustKernel () {
	...
	var CopyMaterial = (function (superclass) {
		...
		if ( superclass ) CopyMaterial.__proto__ = superclass;
		CopyMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var DotScreenMaterial = (function (superclass) {
		...
		if ( superclass ) DotScreenMaterial.__proto__ = superclass;
		DotScreenMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var FilmMaterial = (function (superclass) {
		...
		if ( superclass ) FilmMaterial.__proto__ = superclass;
		FilmMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var GlitchMaterial = (function (superclass) {
		...
		if ( superclass ) GlitchMaterial.__proto__ = superclass;
		GlitchMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var GodRaysMaterial = (function (superclass) {
		...
		if ( superclass ) GodRaysMaterial.__proto__ = superclass;
		GodRaysMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var LuminosityMaterial = (function (superclass) {
		...
		if ( superclass ) LuminosityMaterial.__proto__ = superclass;
		LuminosityMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var SMAABlendMaterial = (function (superclass) {
		...
		if ( superclass ) SMAABlendMaterial.__proto__ = superclass;
		SMAABlendMaterial.prototype = Object.create( superclass && superclass.prototype );
		SMAABlendMaterial.prototype.constructor = SMAABlendMaterial;
	...
	var SMAAColorEdgesMaterial = (function (superclass) {
		...
		if ( superclass ) SMAAColorEdgesMaterial.__proto__ = superclass;
		SMAAColorEdgesMaterial.prototype = Object.create( superclass && superclass.prototype );
		SMAAColorEdgesMaterial.prototype.constructor = SMAAColorEdgesMaterial;
	...
	var SMAAWeightsMaterial = (function (superclass) {
		...
		if ( superclass ) SMAAWeightsMaterial.__proto__ = superclass;
		SMAAWeightsMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var ToneMappingMaterial = (function (superclass) {
		...
		if ( superclass ) ToneMappingMaterial.__proto__ = superclass;
		ToneMappingMaterial.prototype = Object.create( superclass && superclass.prototype );
	...
	var Pass = function Pass(scene, camera, quad) {
	...
	Pass.prototype.render = function render (renderer, readBuffer, writeBuffer, delta, maskActive) {
	...
	Pass.prototype.initialise = function initialise (renderer, alpha) {};
	...
	var BloomPass = (function (Pass) {
		...
		if ( Pass ) BloomPass.__proto__ = Pass;
		BloomPass.prototype = Object.create( Pass && Pass.prototype );
		BloomPass.prototype.constructor = BloomPass;

		var prototypeAccessors = { blurriness: {} };
		...
		prototypeAccessors.blurriness.get = function () { return this.convolutionMaterial.scale; };

		prototypeAccessors.blurriness.set = function (x) {
		...
		BloomPass.prototype.render = function render (renderer, readBuffer) {
		...
		BloomPass.prototype.initialise = function initialise (renderer, alpha) {
		...
		BloomPass.prototype.setSize = function setSize (width, height) {
		...
		Object.defineProperties( BloomPass.prototype, prototypeAccessors );
	...
	var BokehPass = (function (Pass) {
		...
		if ( Pass ) BokehPass.__proto__ = Pass;
		BokehPass.prototype = Object.create( Pass && Pass.prototype );
		...
		BokehPass.prototype.render = function render (renderer, readBuffer, writeBuffer) {
		...
		BokehPass.prototype.initialise = function initialise (renderer) {
		...
		BokehPass.prototype.setSize = function setSize (width, height) {
	...
	var Bokeh2Pass = (function (Pass) {
		...
		if ( Pass ) Bokeh2Pass.__proto__ = Pass;
		Bokeh2Pass.prototype = Object.create( Pass && Pass.prototype );
		Bokeh2Pass.prototype.constructor = Bokeh2Pass;
		...
		Bokeh2Pass.prototype.render = function render (renderer, readBuffer, writeBuffer) {
		...
		Bokeh2Pass.prototype.initialise = function initialise (renderer) {
		...
		Bokeh2Pass.prototype.setSize = function setSize (width, height) {
	...
	var ClearMaskPass = (function (Pass) {
		...
		ClearMaskPass.prototype.render = function render (renderer) {
	...
	var DotScreenPass = (function (Pass) {
		...
		if ( Pass ) DotScreenPass.__proto__ = Pass;
		DotScreenPass.prototype = Object.create( Pass && Pass.prototype );
		...
		DotScreenPass.prototype.render = function render (renderer, readBuffer, writeBuffer) {
		...
		DotScreenPass.prototype.initialise = function initialise (renderer) {
		...
		DotScreenPass.prototype.setSize = function setSize (width, height) {
	...
	var FilmPass = (function (Pass) {
		...
		if ( Pass ) FilmPass.__proto__ = Pass;
		FilmPass.prototype = Object.create( Pass && Pass.prototype );
		...
		FilmPass.prototype.render = function render (renderer, readBuffer, writeBuffer, delta) {
		...
		FilmPass.prototype.initialise = function initialise (renderer) {
		...
		FilmPass.prototype.setSize = function setSize (width, height) {
	...
	var GlitchPass = (function (Pass) {
		...
		if ( Pass ) GlitchPass.__proto__ = Pass;
		GlitchPass.prototype = Object.create( Pass && Pass.prototype );
		...
		GlitchPass.prototype.render = function render (renderer, readBuffer, writeBuffer) {
		...
		GlitchPass.prototype.generateTrigger = function generateTrigger () {
		...
		GlitchPass.prototype.generatePerturbMap = function generatePerturbMap (size) {
	...
	var GodRaysPass = (function (Pass) {
		...
		if ( Pass ) GodRaysPass.__proto__ = Pass;
		GodRaysPass.prototype = Object.create( Pass && Pass.prototype );
		GodRaysPass.prototype.constructor = GodRaysPass;

		var prototypeAccessors = { blurriness: {},intensity: {},samples: {} };
		...
		prototypeAccessors.intensity.get = function () { return this.combineMaterial.uniforms.opacity2.value; };

		prototypeAccessors.intensity.set = function (x) {
		...
		prototypeAccessors.samples.get = function () { return Number.parseInt(this.godRaysMaterial.defines.NUM_SAMPLES_INT); };

		prototypeAccessors.samples.set = function (x) {
		...
		GodRaysPass.prototype.render = function render (renderer, readBuffer) {

			var clearAlpha, background;
			var state = renderer.state;
		...
		GodRaysPass.prototype.initialise = function initialise (renderer, alpha) {
		...
		GodRaysPass.prototype.setSize = function setSize (width, height) {
		...
		Object.defineProperties( GodRaysPass.prototype, prototypeAccessors );
	...
	var MaskPass = (function (Pass) {
		...
		MaskPass.prototype.render = function render (renderer, readBuffer, writeBuffer) {
	...
	var RenderPass = (function (Pass) {
		...
		RenderPass.prototype.render = function render (renderer, readBuffer) {
	...
	var SavePass = (function (Pass) {
		...
		SavePass.prototype.render = function render (renderer, readBuffer) {
	...
	var SMAAPass = (function (Pass) {
		...
		if ( Pass ) SMAAPass.__proto__ = Pass;
		SMAAPass.prototype = Object.create( Pass && Pass.prototype );
		...
		SMAAPass.prototype.render = function render (renderer, readBuffer, writeBuffer) {
		...
		SMAAPass.prototype.initialise = function initialise (renderer) {
		...
		SMAAPass.prototype.setSize = function setSize (width, height) {
	...
	var ShaderPass = (function (Pass) {
		...
		ShaderPass.prototype.render = function render (renderer, readBuffer, writeBuffer) {
	...
	var ToneMappingPass = (function (Pass) {
		...
		if ( Pass ) ToneMappingPass.__proto__ = Pass;
		ToneMappingPass.prototype = Object.create( Pass && Pass.prototype );
		ToneMappingPass.prototype.constructor = ToneMappingPass;

		var prototypeAccessors = { resolution: {},adaptive: {} };
		...
		prototypeAccessors.resolution.get = function () { return this.renderTargetLuminosity.width; };

		prototypeAccessors.resolution.set = function (x) {
		...
		prototypeAccessors.adaptive.get = function () { return this.toneMappingMaterial.defines.ADAPTED_LUMINANCE !== undefined; };

		prototypeAccessors.adaptive.set = function (x) {
		...
		ToneMappingPass.prototype.render = function render (renderer, readBuffer, writeBuffer, delta) {
		...
		ToneMappingPass.prototype.initialise = function initialise (renderer) {
		...
		Object.defineProperties( ToneMappingPass.prototype, prototypeAccessors );
	...
	var EffectComposer = function EffectComposer(renderer, depthTexture, stencilBuffer) {
	...
	EffectComposer.prototype.createBuffer = function createBuffer (stencilBuffer) {
	...
	EffectComposer.prototype.render = function render (delta) {
			var this$1 = this;
		...
		for(i = 0, l = this.passes.length; i < l; ++i) {
			...
			if(pass.enabled) {
				...
				pass.render(this$1.renderer, readBuffer, writeBuffer, delta, maskActive);

				if(pass.needsSwap) {

					if(maskActive) {

						ctx = this$1.renderer.context;
						state = this$1.renderer.state;
						state.setStencilFunc(ctx.NOTEQUAL, 1, 0xffffffff);
						this$1.copyPass.render(this$1.renderer, readBuffer, writeBuffer);
	...
	EffectComposer.prototype.setSize = function setSize (width, height) {
			var this$1 = this;
	...
	EffectComposer.prototype.reset = function reset (renderTarget) {
	...
	EffectComposer.prototype.dispose = function dispose (renderTarget) {
			var this$1 = this;
