(function (three) {
  ...
  var BlurPass = function (_Pass) {
    ...
    function BlurPass() {
      ...
      _this.resolutionScale = resolutionScale;
  ...
  var EffectComposer = function () {
    ...
    _createClass(EffectComposer, [{
      key: "getRenderer",
      value: function getRenderer(renderer) {
  ...
  var BloomEffect = function (_Effect) {
    ...
    function BloomEffect() {
      ...
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          _ref$blendFunction = _ref.blendFunction,
          blendFunction = _ref$blendFunction === void 0 ? BlendFunction.SCREEN : _ref$blendFunction,
          _ref$distinction = _ref.distinction,
          distinction = _ref$distinction === void 0 ? 1.0 : _ref$distinction,
          _ref$resolutionScale = _ref.resolutionScale,
          resolutionScale = _ref$resolutionScale === void 0 ? 0.5 : _ref$resolutionScale,
          _ref$kernelSize = _ref.kernelSize,
          kernelSize = _ref$kernelSize === void 0 ? KernelSize.LARGE : _ref$kernelSize;
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(BloomEffect).call(this, "BloomEffect", fragment$a, {
  ...
  var DepthEffect = function (_Effect) {
    ...
    function DepthEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(DepthEffect).call(this, "DepthEffect", fragment$f, {
        blendFunction: blendFunction,
  ...
  var DotScreenEffect = function (_Effect) {
    ...
    function DotScreenEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(DotScreenEffect).call(this, "DotScreenEffect", fragment$g, {
        blendFunction: blendFunction,
  ...
  var GlitchEffect = function (_Effect) {
    ...
    function GlitchEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(GlitchEffect).call(this, "GlitchEffect", fragment$i, {
        blendFunction: blendFunction,
  ...
  var GodRaysEffect = function (_Effect) {
    ...
    function GodRaysEffect(camera, lightSource) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(GodRaysEffect).call(this, "GodRaysEffect", fragment$a, {
        blendFunction: blendFunction,
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([["texture", new three.Uniform(null)]])
      }));
      ...
      _this.uniforms.get("texture").value = _this.renderTargetY.texture;
      _this.renderTargetLight = _this.renderTargetX.clone();
      ...
      _this.depthMaskPass = new ShaderPass(new DepthMaskMaterial());
  ...
  var GridEffect = function (_Effect) {
    ...
    function GridEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(GridEffect).call(this, "GridEffect", fragment$j, {
        blendFunction: blendFunction,
  ...
  var HueSaturationEffect = function (_Effect) {
    ...
    function HueSaturationEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(HueSaturationEffect).call(this, "HueSaturationEffect", fragment$k, {
        blendFunction: blendFunction,
  ...
  var NoiseEffect = function (_Effect) {
    ...
    function NoiseEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(NoiseEffect).call(this, "NoiseEffect", fragment$l, {
        blendFunction: blendFunction
      }));
  ...
  var OutlineEffect = function (_Effect) {
    ...
    function OutlineEffect(scene, camera) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(OutlineEffect).call(this, "OutlineEffect", fragment$m, {
        blendFunction: blendFunction,
      ...
      _this.renderTargetEdges = _this.renderTargetMask.clone();
      _this.renderTargetEdges.texture.name = "Outline.Edges";
      _this.renderTargetEdges.depthBuffer = false;
      ...
      _this.maskPass = new RenderPass(scene, camera, new DepthComparisonMaterial(_this.depthPass.renderTarget.texture, camera));
      ...
      _this.blur = blur;
      _this.resolution = new three.Vector2();
      _this.outlineEdgesPass = new ShaderPass(new OutlineEdgesMaterial());
  ...
  var PixelationEffect = function (_Effect) {
    ...
    function PixelationEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(PixelationEffect).call(this, "PixelationEffect", fragment$n, {
  ...
  var RealisticBokehEffect = function (_Effect) {
    ...
    function RealisticBokehEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(RealisticBokehEffect).call(this, "RealisticBokehEffect", fragment$o, {
        blendFunction: blendFunction,
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
  ...
  var ScanlineEffect = function (_Effect) {
    ...
    function ScanlineEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(ScanlineEffect).call(this, "ScanlineEffect", fragment$p, {
        blendFunction: blendFunction,
  ...
  var ShockWaveEffect = function (_Effect) {
    ...
    function ShockWaveEffect(camera) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(ShockWaveEffect).call(this, "ShockWaveEffect", fragment$q, {
  ...
  var SMAAEffect = function (_Effect) {
    ...
    function SMAAEffect(searchImage, areaImage) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(SMAAEffect).call(this, "SMAAEffect", fragment$s, {
  ...
  var SSAOEffect = function (_Effect) {
    ...
    function SSAOEffect(camera, normalBuffer) {
      ...
      var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
          ...
          _ref$samples = _ref.samples,
          samples = _ref$samples === void 0 ? 11 : _ref$samples,
          _ref$rings = _ref.rings,
          rings = _ref$rings === void 0 ? 4 : _ref$rings,
          _ref$distanceThreshol = _ref.distanceThreshold,
          distanceThreshold = _ref$distanceThreshol === void 0 ? 0.65 : _ref$distanceThreshol,
          _ref$distanceFalloff = _ref.distanceFalloff,
          distanceFalloff = _ref$distanceFalloff === void 0 ? 0.1 : _ref$distanceFalloff,
          _ref$rangeThreshold = _ref.rangeThreshold,
          rangeThreshold = _ref$rangeThreshold === void 0 ? 0.0015 : _ref$rangeThreshold,
          _ref$rangeFalloff = _ref.rangeFalloff,
          rangeFalloff = _ref$rangeFalloff === void 0 ? 0.01 : _ref$rangeFalloff,
          ...
          radius = _ref$radius === void 0 ? 18.25 : _ref$radius,
          _ref$scale = _ref.scale,
          scale = _ref$scale === void 0 ? 1.0 : _ref$scale,
          _ref$bias = _ref.bias,
          bias = _ref$bias === void 0 ? 0.5 : _ref$bias;
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(SSAOEffect).call(this, "SSAOEffect", fragment$t, {
        blendFunction: blendFunction,
        attributes: EffectAttribute.DEPTH,
  ...
  var TextureEffect = function (_Effect) {
    ...
    function TextureEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(TextureEffect).call(this, "TextureEffect", fragment$a, {
        blendFunction: blendFunction,
  ...
  var ToneMappingEffect = function (_Effect) {
    ...
    function ToneMappingEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(ToneMappingEffect).call(this, "ToneMappingEffect", fragment$u, {
        blendFunction: blendFunction,
  ...
  var VignetteEffect = function (_Effect) {
    ...
    function VignetteEffect() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(VignetteEffect).call(this, "VignetteEffect", fragment$v, {
