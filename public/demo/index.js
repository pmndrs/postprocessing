(function (three) {
	...
	class OutlineBlendMaterial extends three.ShaderMaterial {
	...
	class RealisticBokehMaterial extends three.ShaderMaterial {
	...
	class ShockWaveMaterial extends three.ShaderMaterial {
	...
	class PixelationPass extends Pass {
	...
	class RealisticBokehPass extends Pass {
	...
	class SavePass extends Pass {
		...
		constructor(renderTarget, resize = true) {
			...
			this.renderTarget = (renderTarget !== undefined) ? renderTarget : new three.WebGLRenderTarget(1, 1, {
				minFilter: three.LinearFilter,
				magFilter: three.LinearFilter,
				stencilBuffer: false,
				depthBuffer: false
	...
	class ShockWavePass extends Pass {
	...
	class SMAAPass extends Pass {
		...
		constructor(searchImage, areaImage) {
			...
			this.searchTexture = new three.Texture(searchImage);
			...
			this.searchTexture.format = three.RGBAFormat;
			...
			this.areaTexture = new three.Texture(areaImage);

			this.areaTexture.name = "SMAA.Area";
			this.areaTexture.minFilter = three.LinearFilter;
			this.areaTexture.format = three.RGBAFormat;
	...
	class DepthDemo extends PostProcessingDemo {
		...
		initialize() {
			...
			const camera = new three.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 2, 10);
	...
	class FilmDemo extends PostProcessingDemo {
	...
	class RenderDemo extends PostProcessingDemo {
